Here you can find the functionalities for the headmaster's account implemented in C++ and also the login part of the system for all three types of accounts.
-------
